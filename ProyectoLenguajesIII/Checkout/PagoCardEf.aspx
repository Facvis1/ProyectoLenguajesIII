<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PagoCardEf.aspx.cs" Inherits="ProyectoLenguajesIII.Checkout.PagoCardEf" %>
    ...
    <div class="row">
        ...
        <div class="col-md-8 order-md-1">
            ...
            <form class="needs-validation" novalidate="">
                ...
                <%--<div >
                        <label for="preferences">¿Con cuanto vas a pagar?</label>
                        <asp:TextBox runat="server" class="form-control" id="TextBox1" placeholder="Ingrese un valor igual o menor del precio total." value="" />
