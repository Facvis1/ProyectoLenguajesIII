<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Buy.aspx.cs" Inherits="ProyectoLenguajesIII.Buy" %>
            ...
            <form class="needs-validation" novalidate="">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <asp:TextBox runat="server" class="form-control" id="firstName" placeholder="Facundo" value="" required=""/>                        
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <asp:TextBox runat="server" class="form-control" id="lastName" placeholder="Visa" value="" required=""/>
                ...
                <div class="mb-3">
                    ...
                    <asp:TextBox runat="server" type="text" class="form-control" id="address" placeholder="Av. San Martin 1533, San Lorenzo, Salta" value="" required=""/>       
                    <div class="invalid-feedback"> Direccion requerida </div>
                </div>

                 <div class="mb-3">
                    <label for="phone">Telefono</label>     
                    <asp:TextBox runat="server" type="text" class="form-control" id="phone" placeholder="3876056178" value="" required=""/>       
                ...
                <hr class="mb-4">
                <asp:Button runat="server" ID="cardbtn" Text="PAGAR" />
