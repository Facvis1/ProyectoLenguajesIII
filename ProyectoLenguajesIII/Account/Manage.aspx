<%@ Page Title="Administrar cuenta" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="ProyectoLenguajesIII.Account.Manage" %>
...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        ...
        <td>       
        <asp:Button style="background-color: #00ffff" runat="server" ID="Buybtn" Text="Ver mis ordenes" OnClick="Buybtn_Click"/>
